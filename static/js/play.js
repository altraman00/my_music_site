    ...
    $.ajax({
      ...
      success:function(data){
        ...
        if(dataJson.result == 'success'){
          ...
          html += '<a href="javascript:;" class="users-face" taget="_blank"><img src="/static/users.jpg" width="30" height="30"></a>' +
                  '<div class="reply-users"><a href="javascript:;">匿名用户</a><em>' + dataJson.time + '</em></div>' +
